...
class Sr_VersionCheck_Adminhtml_ConnectmodulesController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $model      = Mage::getModel('sr_version_check/modules');
    ...
    public function gridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('sr_version_check/adminhtml_modules_grid')->toHtml()
        );
    }
    ...
    protected function _getModule()
    {
        ...
        $module = Mage::getModel('sr_version_check/modules');
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('sr_version_check/modules');
    }
}
